    ...
    <div class="freehub-dashboard-layout">
        ...
        <section class="freehub-main-content">
            ...
            <div style="display:grid; grid-template-columns:1fr; gap:20px;">
                ...
                <!-- ACTION BUTTONS -->
                <asp:Panel ID="pnlActions" runat="server" style="display:flex; gap:12px; margin-top:10px;">
                    <asp:Button ID="btnRejectProposal" runat="server"
                        ...
                        style="flex:1;background-color:#fff;color:#dc3545;border:1px solid #dc3545;padding:12px 24px;border-radius:8px;font-size:14px;font-weight:500;cursor:pointer;" />
                    <asp:Button ID="btnRequestChanges" runat="server"
                        Text="&#128172; Request Changes"
                        OnClick="btnRequestChanges_Click"
                        style="flex:1;background-color:#fff;color:#333;border:1px solid #ccc;padding:12px 24px;border-radius:8px;font-size:14px;font-weight:500;cursor:pointer;" />
                    <asp:Button ID="btnApproveProposal" runat="server"
                        ...
                        style="flex:1;background-color:#2e7d56;color:#fff;border:none;padding:12px 24px;border-radius:8px;font-size:14px;font-weight:500;cursor:pointer;" />
                </asp:Panel>
