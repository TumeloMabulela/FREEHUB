    ...
    <div class="my-projects-page">
        ...
        <main class="my-projects-main">
            ...
            <div class="my-projects-heading">
                <div>
                    <h1>My Projects</h1>
                    <p>Manage your active, completed and cancelled projects.</p>
                </div>

                <a href="PostProject.aspx" class="my-projects-post-button">
                    + Post a Project
                </a>
            </div>
            ...
            <section class="my-projects-list-card">
                <div class="my-projects-list-heading">
                    <div>
                        <h2>
                            <asp:Label ID="lblSectionTitle" runat="server" Text="Active Projects" />
                        </h2>
                        <p>Select a project to view its details, proposals and contracts.</p>
                    </div>

                    <asp:DropDownList ID="ddlSortProjects" runat="server" CssClass="my-projects-sort">
                        ...
                        <ItemTemplate>
                            <article class="my-project-card">
                                ...
                                <div class="my-project-actions">
                                    <!-- Conditional Review Work Button for Submissions -->
                                    <asp:PlaceHolder ID="phReviewWork" runat="server" Visible='<%# Eval("projectStatus").ToString() == "Under Review" %>'>
                                        <a href='ReviewWork.aspx?projectId=<%# Eval("projectID") %>' 
                                           style="display:inline-block; color:#fff; background-color:#d97706; text-decoration:none; font-size:13px; font-weight:600; padding:8px 16px; border-radius:20px; margin-right:4px;">
                                            🔍 Review Work
                                        </a>
                                    </asp:PlaceHolder>
                ...
                <asp:Panel ID="pnlEmptyProjects" runat="server" CssClass="my-projects-empty" Visible="false">
                    <div>?</div>
                    <h3>No projects found</h3>
                    <p>There are no projects available in this section.</p>
                </asp:Panel>
            </section>
