...
<head runat="server">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-cancel { flex: 0; background: none; border: 1px solid #d1d9d3; padding: 14px 24px; border-radius: 8px; font-size: 14px; cursor: pointer; color: #555; transition: all 0.2s; text-decoration: none; display: flex; align-items: center; }
        ...
        <div class="container">
            ...
            <div class="create-form">
                ...
                <div class="form-field">
                    ...
                    <asp:TextBox ID="txtBio" runat="server" CssClass="form-textarea" TextMode="MultiLine" Rows="3" placeholder="Tell freelancers about yourself..." />
                </div>

                <div class="form-row">
                    <div class="form-field">
                        <label>Location / City</label>
                        <asp:TextBox ID="txtLocation" runat="server" CssClass="form-input" placeholder="e.g. Cape Town, SA" />
                    </div>
                    <div class="form-field">
